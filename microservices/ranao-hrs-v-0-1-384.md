...
## ***dansalan-gateway*** v.0.1.81
> Date: **Jun 2, 2022, 7:19:25 AM**
### :heavy_check_mark: Fixed Issues
What Issue were fixed.
- verify username password
- add new services function+ApiBearerAuth+JwtAuthGuard in validation
...
## ***employee-service*** v.0.1.51
> Date: **Jun 2, 2022, 2:05:17 AM**
### :heavy_check_mark: Dependencies
>   
    "@nestjs/common": "^7.0.0",
    "@nestjs/config": "^1.1.6",
...
## ***organization-service*** v.0.1.43
> Date: **Jun 8, 2022, 12:50:22 AM**
### :+1: New Features
New features that were added during this release.
- add user signature
...
## ***workday-service*** v.0.1.26
> Date: **Jun 3, 2022, 8:32:03 AM**
### :heavy_check_mark: Dependencies
>
    "@nestjs/common": "^7.0.0",
    "@nestjs/config": "^0.6.1",
...
## ***workflow-service*** v.0.1.236
> Date: **Jun 2, 2022, 3:41:57 AM**
### :heavy_check_mark: Dependencies
>     
    "@babel/core": "^7.12.10",
